...
projects = Project.create([{name: 'Sophisticated Airhead', description: 'This is a fully functioning e-commerce website, built in Rails to showcase my nack for fullstack, and to solicit props for my ruby chops.', image_url: 'Sophisticated_Airhead.png', url: 'https://shaman-swap.herokuapp.com'},
